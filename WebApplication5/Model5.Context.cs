...
namespace WebApplication5
{
    ...
    public partial class InstaLocalEntities : DbContext
    {
        ...
        public virtual int UpdateUtilizador(Nullable<int> iD, string nome, string email, string foto)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateUtilizador", iDParameter, nomeParameter, emailParameter, fotoParameter);
        }
